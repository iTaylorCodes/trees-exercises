...
class BinaryTree {
  ...
  nextLarger(lowerBound) {
    ...
    while (toVisitQueue.length) {
      ...
      let isHigherThanLowerBound = current.val > lowerBound;
      let shouldReassignClosest = current.val < closest || closest === null;

      if (isHigherThanLowerBound && shouldReassignClosest) {
        closest = current.val;
      }
